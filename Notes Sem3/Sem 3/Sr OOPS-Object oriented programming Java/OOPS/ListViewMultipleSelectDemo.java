...
public class ListViewMultipleSelectDemo extends Application
{
   Label response;
...
//final ReadOnlyObjectProperty<T> selectedItemProperty( ) 
  ...
  ObservableList<String> selList =lvSelModel.getSelectedItems( );
   for( String s:selList)
           System.out.println(s);
    System.out.println("////////////");

  ObservableList<Integer> selListOfIndices =lvSelModel.getSelectedIndices( );
for( Integer i:selListOfIndices)
